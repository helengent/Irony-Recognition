...
class acousticTextLSTM_CNN():
    ...
    def __init__(self, acoustic_train, acoustic_dev, acoustic_test, text_train, text_dev, text_test, y_train, y_dev, y_test, tokenizer, csv_path, checkpoint_path, plot_path, class_weights):
        ...
        embeddingConvs = list()
        for pooling_size, conv_size in zip([4], [32]):
        ...
        embedded = layers.Dense(232, activation='relu')(embedded)

        lstm = layers.LSTM(156, activation='relu', dropout=0.0, recurrent_dropout=0.25)(acoustic)
        lstm = layers.Dense(232, activation='relu')(lstm)
        ...
        z = layers.Dense(30, activation='relu')(x.output)
