...
par(new=TRUE);
plot(m1F0, select=2, ylab="", xlab="", main="", col=cbPalette[4])
...
plot_smooth(m1F0, view="time", cond=list("label"="I"), plot_all=c("speaker"), main = "All Speakers (Ironic)", col = cbPalette[1:12], rm.ranef=FALSE)
plot_smooth(m1F0, view="time", cond=list("label"="N"), plot_all=c("speaker"), main = "All Speakers (Non-Ironic)", col = cbPalette[1:12], rm.ranef=FALSE)

```

```{r}
par(mfrow=c(2, 2))
plot_diff(m1F0, view="time", shade=TRUE, cond=list(speaker="c"), comp=list(label=c("I", "N")), rm.ranef = FALSE)
plot_diff(m1F0, view="time", shade=TRUE, cond=list(speaker="d"), comp=list(label=c("I", "N")), rm.ranef = FALSE)
plot_diff(m1F0, view="time", shade=TRUE, cond=list(label="I"), comp=list(speaker=c("c", "d")), rm.ranef = FALSE)
plot_diff(m1F0, view="time", shade=TRUE, cond=list(label="N"), comp=list(speaker=c("c", "d")), rm.ranef = FALSE)
```
