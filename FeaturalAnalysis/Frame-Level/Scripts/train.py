...
def performanceReport(train_stats_all, test_stats_all, speakerList, fileMod):
...
def main(fileMod, speakerList, csv_path, checkpoint_path):
    ...
    for speaker in speakerList:
        ...
        lstm = acousticOnlyLSTM(X_train, X_dev, X_test, y_train, y_dev, y_test, csv_path, checkpoint_path, class_weights)
    ...
    performanceReport(train_performance_list, test_performance_list, speakerList, fileMod)
