...
def main(fileMod, speakerList, csv_path, checkpoint_path, dataDir, speakerSplit="independent"):
    ...
    if speakerSplit == "independent":
        for speaker in speakerList:
            ...
            X_train = np.load("{}/{}_{}LeftOut_train_acoustic.npy".format(dataDir, fileMod, speaker))
            X_dev = np.load("{}/{}_{}LeftOut_dev_acoustic.npy".format(dataDir, fileMod, speaker))
            X_test = np.load("{}/{}_{}LeftOut_test_acoustic.npy".format(dataDir, fileMod, speaker))

            y_train = np.load("{}/{}_{}LeftOut_train_labels.npy".format(dataDir, fileMod, speaker))
            y_dev = np.load("{}/{}_{}LeftOut_dev_labels.npy".format(dataDir, fileMod, speaker))
            y_test = np.load("{}/{}_{}LeftOut_test_labels.npy".format(dataDir, fileMod, speaker))
        ...
        #Load data
        X_train = np.load("{}/{}_train_acoustic.npy".format(dataDir, fileMod))
        X_dev = np.load("{}/{}_dev_acoustic.npy".format(dataDir, fileMod))
        X_test = np.load("{}/{}_test_acoustic.npy".format(dataDir, fileMod))

        y_train = np.load("{}/{}_train_labels.npy".format(dataDir, fileMod))
        y_dev = np.load("{}/{}_dev_labels.npy".format(dataDir, fileMod))
        y_test = np.load("{}/{}_test_labels.npy".format(dataDir, fileMod))
...
if __name__=="__main__":
    ...
    dataDir = "/home/hmgent2/Data/ModelInputs/percentChunks"

    for speakerSplit in speakerSplits:

        main(fileMod, speakerList, csv_path, checkpoint_path, dataDir, speakerSplit=speakerSplit)